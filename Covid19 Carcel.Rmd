...
geom_text_repel(data=subset(contagio.largo, fecha=="2020-04-15" | fecha=="2020-04-30" | fecha=="2020-05-15" | fecha=="2020-05-31" | fecha=="2020-06-15" | fecha=="2020-06-30"| fecha=="2020-07-15" | fecha=="2020-07-22"), aes(y=value,label=value),size=4, fontface="bold", position="identity",show.legend=FALSE) +
xlab("") + ylab("") +
scale_x_date(date_breaks = "10 day", date_labels = "%d-%m") +
theme_ipsum() +
ggtitle("Contagio Covid-19 en Cárceles de Chile (22jul2020)") +
...
smooth_new_cases <- function(cases){
  cases %>%
    ...
    dplyr::select(date, cases, new_cases, new_cases_smooth)
}
